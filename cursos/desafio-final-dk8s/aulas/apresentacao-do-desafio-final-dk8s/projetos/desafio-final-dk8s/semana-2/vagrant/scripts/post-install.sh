...
echo "[1/7] Installing useful tools..."
...
echo "[2/7] Configuring kubectl bash completion..."
...
echo "[3/7] Creating useful aliases..."
...
echo "[4/7] Installing Metrics Server (optional)..."
...
echo "[5/7] Installing local-path-provisioner (default StorageClass)..."
...
echo "[6/7] Creating example namespace and helpful scripts..."
...
echo "✓ Example namespace and helper scripts created"
echo ""
...
echo "  ✓ local-path StorageClass (default)"
echo "  ✓ Example namespace"
echo "  ✓ Helper scripts"
echo ""
echo "  Next step: run .\scripts\install-addons.ps1 from Windows PowerShell"
echo "  to install ingress-nginx, cert-manager and nfs-ganesha."
echo ""
echo "🚀 Quick start:"
