...
# [2/6] tipsbank-contas
Write-Host "`n[2/6] tipsbank-contas" -ForegroundColor Cyan
...
# [4/6] tipsbank-auditoria
Write-Host "`n[4/6] tipsbank-auditoria" -ForegroundColor Cyan
...
# [5/6] tipsbank-web
Write-Host "`n[5/6] tipsbank-web" -ForegroundColor Cyan
...
# [6/6] monitoring + locust
Write-Host "`n[6/6] monitoring + locust" -ForegroundColor Cyan
